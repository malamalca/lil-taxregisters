...
class BusinessPremisesController extends AppController
{
    ...
    {
        $businessPremises = $this->BusinessPremises->findForOwner('all', $this->Auth->user('company_id'));
    ...
    public function edit($id = null)
    {
        if ($id) {
            ...
            $businessPremise = $this->BusinessPremises->newEntity();
            $businessPremise->owner_id = $this->Auth->user('company_id');
        }
    ...
    public function register($id = null)
    {
        ...
        if (!$p12 && !$this->Auth->user('cert_p12')) {
